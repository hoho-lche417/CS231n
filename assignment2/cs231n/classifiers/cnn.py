...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params['b1'] = np.random.normal(loc=0.0, 
            scale=weight_scale, size=(num_filters,))
        
        self.params['W2'] = np.random.normal(loc=0.0, 
            scale=weight_scale, 
            size=(num_filters * H * W // 4, hidden_dim))
        self.params['b2'] = np.random.normal(loc=0.0, 
            scale=weight_scale, size=(hidden_dim,))

        self.params['W3'] = np.random.normal(loc=0.0, 
            scale=weight_scale, 
            size=(hidden_dim, num_classes))
        self.params['b3'] = np.random.normal(loc=0.0, 
            scale=weight_scale, size=(num_classes,))
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
    ...
    def loss(self, X, y=None):
        ...
        loss += 0.5 * self.reg * (np.sum(grads['W1'] ** 2) + \
            np.sum(grads['W2'] ** 2) + np.sum(grads['W3'] ** 2))
